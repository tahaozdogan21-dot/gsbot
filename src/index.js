...
const FORMA_GORSELLERI = {
  '0011': 'https://res.cloudinary.com/dzfiyamng/image/upload/v1779228420/BJK_BEYAZ_RETRO_hhvwsb.jpg',
  '0012': 'https://res.cloudinary.com/dzfiyamng/image/upload/v1779228423/BJK_BEYAZ_RETRO_afsrb9.jpg',
  '0013': 'https://res.cloudinary.com/dzfiyamng/image/upload/v1779228420/BJK_BEYAZ_RETRO_hxfej8.jpg',
  '0014': 'https://res.cloudinary.com/dzfiyamng/image/upload/v1779228421/BJK_BEYAZ_RETRO_wvjtrj.jpg',
};
...
=== DİĞER TAKIMLAR ===
"Bu sayfamızda Galatasaray ağırlıklı gidiyoruz. Diğer modeller için 0536 630 3654 WhatsApp hattımızdan katalog iletebiliriz."

=== KAÇ ADET / HANGİ TAKIM ===
"Galatasaray mı yoksa başka takım mı?" sor. Galatasaray: güncel modelleri göster. Diğer: WhatsApp yönlendir.
  ...
  try {
    ...
    for (const entry of body.entry) {
      ...
      for (const event of (entry.messaging || [])) {
        ...
        // Takip mesajı timer'ını sıfırla
        if (durum.takipTimer) {
          clearTimeout(durum.takipTimer);
          durum.takipTimer = null;
        }
